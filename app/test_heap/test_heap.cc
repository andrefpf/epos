...
void * APP_HEAP = reinterpret_cast<void *> (Memory_Map::APP_HEAP);
...
void test_2(char * ptr) {
    ...
    Heap * heap = reinterpret_cast<Heap *> (*(addr - 2)); // Figure out heap like in Heap::typed_free
