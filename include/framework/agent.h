...
void Agent::handle_task()
{
    ...
    case TASK_ADDRESS_SPACE:
        res = reinterpret_cast<long>(task->address_space());
        break;
    case TASK_CODE_SEGMENT:
        res = reinterpret_cast<long>(task->code_segment());
        break;
    case TASK_DATA_SEGMENT:
        res = reinterpret_cast<long>(task->data_segment());
        break;
    case TASK_CODE:
        res = task->code();
        break;
    case TASK_DATA:
        ...
        break;
    case TASK_MAIN:
        res = reinterpret_cast<long>(task->main());
        break;
    default:
        res = UNDEFINED;
    }
...
void Agent::handle_alarm()
{
    ...
    case ALARM_DELAY: {
        db<Framework>(TRC) << "Handle(BABA2)" << endl;
        Microsecond time;
        in(time);
